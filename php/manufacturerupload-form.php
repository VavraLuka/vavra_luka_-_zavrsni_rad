<section class="newproduct-form">
    <form method="POST" action="php/newmanufacturer-process.php" accept-charset="UTF-8" autocomplete="off">
        ...
        <textarea name="description" id="description" maxlength="1200" placeholder="Opis proizvođača" required oninvalid="this.setCustomValidity('Obavezan opis proizvođača')"></textarea>
        <input type="text" name="imageURL" id="imageURL" maxlength="100" placeholder="Fotografija vizualnog identiteta proizvođača" required oninvalid="this.setCustomValidity('Obavezna fotografija vizualnog identiteta')"><br>
