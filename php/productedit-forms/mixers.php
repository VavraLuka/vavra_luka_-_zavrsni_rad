<section class="newproduct-form">
    <form method="POST" action="php/editproduct-process.php" accept-charset="UTF-8" autocomplete="off">
        ...
        <div class="three-inputs">
            <div class="input-div-three"><input type="number" name="faders" maxlength="3" id="faders" placeholder="Broj potenciometara" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['faders']; ?>"><br></div>
            <div class="input-div-three"><input type="number" name="inputs" maxlength="3" id="inputs" placeholder="Broj ulaza" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['inputs']; ?>"><br></div>
            <div class="input-div-three"><input type="number" name="outputs" maxlength="3" id="outputs" placeholder="Broj izlaza" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['outputs']; ?>"><br></div>
        </div>
        <div class="two-inputs">
            <div class="input-div-two"><input type="text" name="dimensions" maxlength="24" id="dimensions" placeholder="Dimenzije (mm)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['dimensions']; ?>"><br></div>
            <div class="input-div-two"><input type="number" name="weight" maxlength="6" id="weight" step="0.1" placeholder="Težina (kg)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['weight']; ?>"><br></div>
        </div>
