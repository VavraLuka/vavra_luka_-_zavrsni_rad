<section class="newproduct-form">
    <form method="POST" action="php/editproduct-process.php" accept-charset="UTF-8" autocomplete="off">
        ...
        <input type="text" name="softwareSupport" id="softwareSupport" maxlength="100" placeholder="Kompatibilni software" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['softwareSupport']; ?>"><br>
        <div class="two-inputs">
            <div class="input-div-two"><input type="number" maxlength="4" name="deckNumber" id="deckNumber" placeholder="Broj deck-ova" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['deckNumber']; ?>"><br></div>
