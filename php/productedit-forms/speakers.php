<section class="newproduct-form">
    <form method="POST" action="php/editproduct-process.php" accept-charset="UTF-8" id="productForm" autocomplete="off">
        ...
        <input type="text" maxlength="60" name="name" id="name" placeholder="Naziv proizvoda" required oninvalid="this.setCustomValidity('Obavezan naziv proizvoda')" value="<?php echo $name; ?>"><br>
        <label for="manufacturer">Proizvođač</label>
        <input type="text" maxlength="30" name="manufacturer" id="manufacturer" placeholder="Proizvođač" required oninvalid="this.setCustomValidity('Obavezan naziv proizvođača')" value="<?php echo $manufacturer; ?>"><br>
        ...
        <select class="input-type" name="speakerType" id="speakerType" required oninvalid="this.setCustomValidity('Obavezan tip zvučnika')">
            ...
            <?php
            $speakerTypes = [
                "speakerBundle" => "Komplet razglasa",
            ...
            foreach ($speakerTypes as $value => $label) {
                $selected = ($speakerType == $value) ? 'selected' : '';
        ...
        <input type="text" name="drivers" maxlength="100" id="drivers" placeholder="Driveri" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $drivers; ?>"><br>
        <div class="three-inputs">
            <div class="input-div-three"><label for="RMS">RMS (W)</label><input maxlength="4" type="number" name="RMS" id="RMS" placeholder="RMS (W)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $RMS; ?>"><br></div>
            <div class="input-div-three"><label for="maxPower">Maksimalna snaga (W)</label><input maxlength="4" type="number" name="maxPower" id="maxPower" placeholder="Maksimalna snaga (W)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $maxPower; ?>"><br></div>
            <div class="input-div-three"><label for="soundPressure">Maksimalna glasnoća (dB)</label><input maxlength="4" type="number" name="soundPressure" id="soundPressure" placeholder="Maksimalna glasnoća (dB)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $soundPressure; ?>"><br></div>
        </div>
        <div class="two-inputs">
            <div class="input-div-two"><label for="minFrequency">Minimalna frekvencija (Hz)</label><input maxlength="3" type="number" name="minFrequency" id="minFrequency" placeholder="Minimalna frekvencija (Hz)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $minFrequency; ?>"><br></div>
            <div class="input-div-two"><label for="maxFrequency">Maksimalna frekvencija (Hz)</label><input maxlength="5" type="number" name="maxFrequency" id="maxFrequency" placeholder="Maksimalna frekvencija (Hz)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $maxFrequency; ?>"><br></div>
        </div>
        <div class="two-inputs">
