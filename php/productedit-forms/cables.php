<section class="newproduct-form">
    ...
    <input type="hidden" name="id" id="id" value="<?php echo $row['id'] ?>">
        ...
        <div class="three-inputs">
            ...
            <div class="input-div-three"><input type="number" maxlength="14" name="length" id="length" step="0.1" placeholder="Duljina kabla (cm)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['length']; ?>"><br></div>
            <div class="input-div-three"><input type="text" maxlength="10" name="color" id="color" placeholder="Boja" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['color']; ?>"><br></div>
        </div>
        <div class="two-inputs">
