    ...
    <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
        ...
        <div class="three-inputs">
            <div class="input-div-three"><label for="limiter">Sadrži limiter</label><select class="input-type" name="limiter" id="limiter" required oninvalid="this.setCustomValidity('Obavezno polje')">
                    ...
                    <option value="Da" <?php if ($limiter == "Da") echo "selected"; ?>>Da</option>
                    <option value="Ne" <?php if ($limiter == "Ne") echo "selected"; ?>>Ne</option>
                </select><br></div>
            <div class="input-div-three"><label for="channels">Broj kanala</label><input type="number" maxlength="3" name="channels" id="channels" placeholder="Broj kanala" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $channels; ?>"><br></div>
            <div class="input-div-three"><label for="power">Snaga (W)</label><input type="number" maxlength="6" name="power" id="power" placeholder="Snaga (W)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $power; ?>"><br></div>
        </div>
        <div class="two-inputs">
            <div class="input-div-two"><label for="minFrequency">Minimalna frekvencija (Hz)</label><input type="number" maxlength="3" name="minFrequency" id="minFrequency" placeholder="Minimalna frekvencija (Hz)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $minFrequency; ?>"><br></div>
            <div class="input-div-two"><label for="maxFrequency">Maksimalna frekvencija (Hz)</label><input type="number" maxlength="5" name="maxFrequency" id="maxFrequency" placeholder="Maksimalna frekvencija (Hz)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $maxfrequency; ?>"><br></div>
        </div>
        <div class="two-inputs">
