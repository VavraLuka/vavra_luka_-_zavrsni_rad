<section class="newproduct-form">
    ...
    <input type="hidden" name="id" id="id" value="<?php echo $row['id'] ?>">
        ...
        <div class="three-inputs">
            ...
            <div class="input-div-three"><input type="number" maxlength="3" name="channels" id="channels" placeholder="Broj kanala" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['channels']; ?>"><br></div>
            <div class="input-div-three"><input type="number" maxlength="6" name="power" id="power" placeholder="Snaga (W)" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['power']; ?>"><br></div>
        </div>
        <div class="two-inputs">
            <div class="input-div-two"><input type="number" maxlength="3" name="minFrequency" id="minFrequency" placeholder="Minimalna frekvencija" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['minFrequency']; ?>"><br></div>
            <div class="input-div-two"><input type="number" maxlength="5" name="maxFrequency" id="maxFrequency" placeholder="Maksimalna frekvencija" required oninvalid="this.setCustomValidity('Obavezno polje')" value="<?php echo $row['maxfrequency']; ?>"><br></div>
        </div>
        <div class="two-inputs">
