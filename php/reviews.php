...
if ($review > 0 and $review <= 0.5) {
    echo "<img src='images/halfStarIcon.png' class='inline-block' width='$starWidth'>
        ...
        <img src='images/emptyStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/emptyStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/emptyStarIcon.png' class='inline-block' width='$starWidth'><p class='inline-block' style='margin-left: 6px;'>($review)</p>";
    ...
    echo "<img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        ...
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/halfStarIcon.png' class='inline-block' width='$starWidth'><p class='inline-block' style='margin-left: 6px;'>($review)</p>";
} else if ($review > 4.5) {
    echo "<img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'>
        <img src='images/fullStarIcon.png' class='inline-block' width='$starWidth'><p class='inline-block' style='margin-left: 6px;'>($review)</p>";
} else {
