    ...
    <div class="signin-section vertical-padding">
        ...
        <div class="signin-form">
            <form action="php/signin-process.php" method="post" autocomplete="off">
                ...
                <a style="text-decoration: none; color: var(--main-blue-color); transition: 0.15s;" onmouseover="this.style.opacity='75%';" onmouseout="this.style.opacity='100%';" href="passwordrecovery.php"><p>Zaboravili ste lozinku?</p></a>
            </form>
            <?php
            if (isset($_GET["error"])) {
