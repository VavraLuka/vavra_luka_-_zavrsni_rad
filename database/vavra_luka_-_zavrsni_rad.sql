...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2023 at 09:03 AM
...
CREATE TABLE `products` (
  ...
  `speakerType` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `drivers` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `dimensions` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `cableType` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `length` float DEFAULT NULL,
  `leftJack` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `leftJackType` varchar(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rightJack` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rightJackType` varchar(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limiter` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `channels` int(3) DEFAULT NULL,
  `power` int(6) DEFAULT NULL,
  `lightSource` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `powerConsumption` int(5) DEFAULT NULL,
  `lightType` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `beamAngle` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount` int(3) NOT NULL DEFAULT 0,
  `caseFor` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `caseType` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accessoryType` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(800) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLine1` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLineValue1` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLine2` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLineValue2` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLine3` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additionalLineValue3` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review` float NOT NULL DEFAULT 0,
  `reviewCount` int(5) NOT NULL DEFAULT 0,
  `softwareSupport` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deckNumber` int(4) DEFAULT NULL,
  `externalPowerSource` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(22, 'cables', 'Powercord UK C13', 'the sssnake', 3.99, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/110068/9193875_800.jpg', 32, NULL, NULL, NULL, 'powerCable', 150, 'UK utikaÄ', 'male', 'C13', 'male', 'Crna', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, NULL, NULL, NULL, NULL, 'ZaÅ¡tita', '13 A fuse', NULL, NULL, NULL, NULL, 4.4, 23, NULL, NULL, NULL),
(23, 'cables', 'Mains Power Cable', 'the sssnake', 6.2, 20, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/175751/10823761_800.jpg', 11, NULL, NULL, NULL, 'powerCable', 500, 'EU utikaÄ', 'male', 'C13', 'male', 'Crna', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4.5, 3, NULL, NULL, NULL),
...
(26, 'speakers', 'Dave 18 G4X', 'LD Systems', 1769, 6, 'speakerBundle', '18\" subwoofer + 2x 8\" satelit zvuÄnika', 2000, 4000, 134, 20000, 30, 'ViÅ¡e dimenzija', 63.2, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/557059/17988703_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '90Â° x 30Â°', 'Subwoofer dimenzije', '665 x 545 x 640', 'Satelit zvuÄnik dimenzije', '260 x 275 x 470', 0, 0, NULL, NULL, NULL),
(27, 'speakers', 'EON 715 Power Bundle', 'JBL', 3444, 10, 'speakerBundle', '2x 18\" woofer + 2x 15\" woofer i 1\" visokotonac', 2800, 5600, 134, 20000, 40, 'ViÅ¡e dimenzija', 103, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/532960/16823683_800.jpg', 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Subwoofer dimenzija', '609 x 667 x 637', 'Satelit zvuÄnik dimenzija', '382 x 669 x 324', 'Dodatna oprema', '2x stalak + 2x XLR kabel', 0, 0, NULL, NULL, NULL),
(28, 'speakers', 'CL 106/112MKII Basis Bundle', 'the box', 559, 10, 'speakerBundle', '12\" subwoofer + 2x 6.5\" woofer + kompresijski driver', 320, 1100, 118, 19000, 40, 'ViÅ¡e dimenzija', 45, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/350772/9191755_800.jpg', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '90Â° x 60Â°', 'Subwoofer dimenzija', '420 x 520 x 500', 'Satelit zvuÄnik dimenzija', ' 250 x 230 x 375', 3.7, 5, NULL, NULL, NULL),
(29, 'speakers', 'CL 108/115MKII Basis Bundle', 'the box', 729, 4, 'speakerBundle', '15\" woofer + 2x  8\" woofer + 1\" kompresijski driver', 520, 1700, 122, 19000, 35, 'ViÅ¡e dimenzija', 58, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/350775/9191790_800.jpg', 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Subwoofer dimenzija', '460 x 630 x 610', 'Satelit zvuÄnik dimenzija', '280 x 250 x 415', 'Disperzija zvuka', '90Â° x 60Â°', 2.3, 4, NULL, NULL, NULL),
(30, 'speakers', 'Achat 112 Sub A & DSP108 Set', 'the box pro', 990, 10, 'speakerBundle', '2x 12\" Subwoofer + 2x 8\" woofer + 1\" kompresijski driver ', 1100, 2600, 124, 18000, 40, 'ViÅ¡e dimenzija', 59.4, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/478977/14632136_800.jpg', 12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Subwoofer dimenzija', '450 x 380 x 456', 'Satelit zvuÄnik dimenzija', '487 x 275 x 270', 'Disperzija zvuka', '90Â° x 60Â°', 5, 3, NULL, NULL, NULL),
(31, 'speakers', 'DSX 110 M', 'the box pro', 199, 6, 'monitorSpeaker', '10\" woofer + 1.35\" koaksijalan driver', 300, 900, 130, 18000, 60, '450 x 535 x 403', 14.6, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/505046/16368648_800.jpg', 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, NULL, NULL, NULL, '', 'Disperzija zvuka', '60Â° x 60Â°', 'Otvor za stalak', '36 mm', 'PojaÄalo', 'Class D + AB', 3.9, 7, NULL, NULL, NULL),
(32, 'speakers', 'MA120 MKII', 'the box', 149, 6, 'monitorSpeaker', '12\" Woofer + visokotonac', 120, 240, 120, 16000, 80, '370 x 580 x 420', 16.5, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/195950/7228139_800.jpg', 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, NULL, NULL, NULL, '', 'KuÄ‡iÅ¡te', 'Drvo', 'Broj ulaza', '2', NULL, NULL, 4, 3, NULL, NULL, NULL),
(33, 'accessories', 'Stage Tape 400BK', 'Stairville', 3.99, 78, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/154244/10404437_800.jpg', 52, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'other', NULL, 'DuÅ¾ina', '50 m', 'Å irina', '50 mm', 'Boja', 'Crna', 4.7, 36, NULL, NULL, NULL),
(34, 'cables', 'SM6RD', 'the sssnake', 5.3, 30, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/158895/8585436_800.jpg', 26, NULL, NULL, NULL, 'microphoneCable', 600, 'XLR', 'female', 'XLR', 'male', 'Crvena', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 'Presjek Å¾ice', '2 x 0.22 mmÂ²', NULL, NULL, NULL, NULL, 4.4, 13, NULL, NULL, NULL),
...
(36, 'speakers', 'B615D', 'Behringer', 355, 20, 'activeSpeaker', '15\" woofer + 1.75\" kompresijski driver', 500, 1500, 126, 18000, 60, '732 x 470 x 424', 29.7, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/280265/14837521_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Plastika', NULL, NULL, 0, 0, NULL, NULL, NULL),
...
(38, 'speakers', 'PA 302 A', 'the box', 266, 10, 'activeSpeaker', '12\" woofer + VCD visokotonac', 400, 800, 120, 18000, 50, '600 x 415 x 390', 23, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/160813/12651136_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '55 x 55Â° -100Â°', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Plastika', 0, 0, NULL, NULL, NULL),
(39, 'speakers', 'B115W', 'Behringer', 345, 10, 'activeSpeaker', '15\" woofer + 1\" visokotonac', 250, 1000, 128, 20000, 45, '713 x 427 x 313', 17.7, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/319596/14413009_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Bluetooth', 'Da', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Plastika', 0, 0, NULL, NULL, NULL),
(40, 'speakers', 'ZLX 12P', 'EV', 435, 10, 'activeSpeaker', ' 12\" woofer + 1.5\" kompresijski driver', 250, 1000, 125, 20000, 55, '610 x 356 x 356', 15.6, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/313039/14407389_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '90Â° x 60Â°', 'PojaÄalo', 'Class D', 'KuÄ‡iÅ¡te', 'Polipropilen plastika', 0, 0, NULL, NULL, NULL),
(41, 'speakers', 'Mon A12', 'the box pro', 348, 8, 'monitorSpeaker', '12\" woofer + 1,35\" koaksijalni visokotonac', 350, 700, 124, 20000, 50, '510 x 340 x 500', 15, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/309205/7360603_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '80Â° x 80Â°', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Drvo', 0, 0, NULL, NULL, NULL),
(42, 'speakers', 'B112D', 'Behringer', 239, 10, 'activeSpeaker', '12\" woofer + 1,35\" kompresijski driver', 350, 1000, 128, 20000, 50, '568 x 342 x 270', 12.3, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/284049/15160138_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Boja', 'Siva', 'KuÄ‡iÅ¡te', 'Plastika', 'Utor za stalak', '35 mm', 0, 0, NULL, NULL, NULL),
(43, 'speakers', 'PA 502', 'the box', 218, 8, 'passiveSpeaker', '15\" woofer + horn sa 44 mm titanijskim driver-om', 300, 600, 122, 20000, 35, '715 x 495 x 450', 25.5, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/160814/12315732_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Plastika', NULL, NULL, 0, 0, NULL, NULL, NULL),
(44, 'speakers', 'Achat 204 A', 'the box pro', 133, 6, 'activeSpeaker', ' 2x 4\" woofer + 1\" Fabric dome visokotonac', 80, 320, 112, 20000, 90, '172 x 142 x 360', 4.5, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/375150/17386838_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'Disperzija zvuka', '90Â° x 90Â°', 'Boja', 'Crna', 'KuÄ‡iÅ¡te', 'Drvo', 0, 0, NULL, NULL, NULL),
(45, 'speakers', 'MA120 MKII', 'the box', 149, 12, 'monitorSpeaker', '12\" woofer + visokotonac', 120, 240, 120, 16000, 80, '370 x 580 x 420', 16.5, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/195950/7228139_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'KuÄ‡iÅ¡te', 'Drvo', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL),
...
(51, 'amplifiers', 'TA 2400 MK-X', 'the t.amp', 333, 24, NULL, NULL, NULL, NULL, NULL, 0, 0, '420 x 450 x 95', 19.7, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/156557/15007245_800.jpg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Da', 2, 2400, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '', 'RMS 4 ohma', '2x 1200 W', 'RMS 8 ohma', '2x 760 W', 'PojaÄalo', 'Class AB', 0, 0, NULL, NULL, NULL),
...
CREATE TABLE `users` (
  ...
  `surname` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `passwordUser` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(15, 'Ivana', 'BoÅ¾iÄ‡', 'Ilije GaraÅ¡anina 15', 11000, 'Beograd', 'Srbija', '+381641234567', 'ivana.bozic@gmail.com', '$2y$10$GBCvwwwGQ91ld5JKBT3OEuXC1wr60d1fQQNRRS3WyYw1SlOrse9zm', 0),
(16, 'Adis', 'SmajloviÄ‡', 'Äoke MazaliÄ‡a 23', 71000, 'Sarajevo', 'BiH', '+38761123456', 'adis.smajlovic@yahoo.com', '$2y$10$I/v4kZPvFaZX7RHxRqaPj.8C5RyBBoqwuVSLiqKonQ4ilNvwROtMe', 0),
(17, 'Gergely', 'Nagy', 'DÃ³zsa GyÃ¶rgy Ãºt 1', 1056, 'BudimpeÅ¡ta', 'MaÄ‘arska', '+36201234567', 'gergely.nagy@hotmail.com', '$2y$10$FWYoV6cn2BG49XBUR4pdoeAnMp3YSA5LTHpqw7dkRkWZzsW1gN46m', 0),
...
(20, 'Jovan', 'PetroviÄ‡', 'Svetog Petra Cetinjskog 147', 81000, 'Podgorica', 'CrnaGora', '+38267123456', 'jovan.petrovic@hotmail.com', '$2y$10$McWr2o6UfLeNC7mB5MAL2uaMfu4VRNrjn5Hpf6DJEfoLb6y20MJPa', 0),
(21, 'Ivan', 'PetroviÄ‡', 'Ulica Franje TuÄ‘mana 10', 31000, 'Osijek', 'Hrvatska', '+385987654321', 'ivan.petrovic@email.com', '$2y$10$.qaMFPOQFxvqY4iv6fKf8Ojkm5ALHex0FC755QeDTF/DGg1KlIta.', 0),
(22, 'Jelena', 'StojanoviÄ‡', 'Bulevar Despota Stefana 17', 11000, 'Beograd', 'Srbija', '+381623456789', 'jelena.stojanovic@email.com', '$2y$10$bBL30XjnM9H9XpwJm8iXBODe5RRXTm8yiS9toasXMYMvRQbPPkW0y', 0),
(23, 'Mirza', 'Å ariÄ‡', 'Zmaja od Bosne 22A', 71000, 'Sarajevo', 'BiH', '+38761123456', 'mirza.saric@email.com', '$2y$10$fza3ywhiZ34WZ9BgzjT9GOOg2/DgeNJtg8YBGoH83T68mggp1znEq', 0),
(24, 'Eszter', 'Nagy', 'RÃ¡kÃ³czi tÃ©r 1', 1084, 'Budapest', 'MaÄ‘arska', '+36304567890', 'eszter.nagy@email.com', '$2y$10$UypSCK5RDE7PjCexkjOU7.T0oXIBgZOnTI30YKAhVZiC5nPag9jby', 0),
(25, 'Maja', 'KovaÄ', 'Kardeljeva ulica 17', 1000, 'Ljubljana', 'Slovenija', '+38640987654', 'maja.kovac@email.com', '$2y$10$o1s8qKn8JKgcwzH5RmJZnOXIQtc6zKmIcXgen/MDVHuf.W36Ps/b6', 0),
...
(27, 'Nenad', 'JankoviÄ‡', 'Ul. 13. jul bb', 81000, 'Podgorica', 'CrnaGora', '+38268234567', 'nenad.jankovic@email.com', '$2y$10$8zW/jB09S0roiul0nHauQ.HXFMf7rutKmufeKPMiHGLNafaB1VtBi', 0),
(28, 'Luka', 'Vavra', 'RadiÄ‡eva 13', 43500, 'Daruvar', 'Hrvatska', '+385981330950', 'lvavra@tvz.hr', '$2y$10$z4mHz5sO49ULoWlRRYcZTeBThdrJOzHkAknqNeggRB9RXLLepHRnC', 1);
